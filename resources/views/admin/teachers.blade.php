...
<div class="card">
    <div class="card-body p-0">
        @if($teachers->isEmpty())
            <div class="alert alert-info m-3 mb-0">No teachers found.</div>
        @endif
                                ...
                                <div class="dropdown action-menu dropstart">
                                    ...
                                    <ul class="dropdown-menu">
                                        @if(!$teacher->is_approved)
                                            <li>
                                                <button type="button"
                                                        class="dropdown-item text-success js-open-confirm"
                                                        data-action-url="{{ route('admin.teachers.approve', $teacher) }}"
                                                        data-action-method="POST"
                                                        data-action-title="Approve Teacher"
                                                        data-action-message="Approve {{ $teacher->name }} as teacher?"
                                        ...
                                        @endif
                                        <li>
                                            <a href="{{ route('admin.users.edit', $teacher) }}" class="dropdown-item">
                                        ...
                                        <li>
                                            <button type="button"
                                                    ...
                                                    data-action-url="{{ route('admin.teachers.delete', $teacher) }}"
                                                    data-action-method="DELETE"
                                                    data-action-title="Delete Teacher"
                                                    data-action-message="Delete {{ $teacher->name }}? This action cannot be undone."
