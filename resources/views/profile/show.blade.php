                    ...
                    @if($user->isStudent())
                        @if($user->student_id)
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8"><strong>{{ $user->student_id }}</strong></div>
                            </div>
                        @endif
                        ...
                        @if($user->course)
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8"><strong>{{ $user->course }}</strong></div>
                            </div>
                        @endif

                        @if($user->section)
                            <div class="row mb-3">
                                <div class="col-md-4 text-muted">Section</div>
                                <div class="col-md-8"><strong>{{ $user->section }}</strong></div>
                            </div>
                        @endif
                    @endif
